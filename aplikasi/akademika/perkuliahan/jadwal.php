...
$jadwal = $koneksi_db->sql_query("DELETE FROM t_jadwal WHERE idj='$_GET[idj]'");
echo "<div class=error>Jadwal Telah dihapus</div>";
echo "<meta http-equiv='refresh' content='2; url=index.php?m=".$_GET['m']."'>";
Daftar();
}

function Jadwal() {
global $koneksi_db, $tahun_id, $prodi,$s;
...
<div class="table-responsive">
                <table class="table table-striped table-bordered table-hover" >
					<tr>
				    	<th width="20" rowspan="2" valign="middle"align="center">ID</th>
						...
						<th width="20" rowspan="2" valign="middle"align="center">Kode</th>
					...
					<tr>
                        ...
                        echo '<tr>
                                <td valign="top" align="center">'.$k['id'].'</td>
						...
						echo '
								<td valign="top" >
								<a class="btn btn-primary"  href="index.php?m='.$_GET['m'].'&op=editJadwal&md=0&idj='.$id.'" >Edit</a>
				                 <a href="#" class="btn"  onclick="window.location.href=\'index.php?m='.$_GET['m'].'&op=hapus&idj='.$k['idj'].'\';">
