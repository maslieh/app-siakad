(function($){
  ...
  var WysiHTML5N = function(textarea, options){
    ...
    var toolbar = {
      ...
      modals: {
        insertLink:'<div class="modal" data-wysihtml5-dialog="createLink" style="display: none;z-index:99999999999999">' +
          ...
          '</div>' +
          '</div>',
        insertImage:'<div class="modal" data-wysihtml5-dialog="insertImage" style="display: none;z-index:99999999999999">' +
          '<div class="modal-header">' +
          '<button type="button" class="close" data-wysihtml5-dialog-action="cancel" data-dismiss="modal">×</button>' +
          '<h3>Insert Image</h3>' +
          '</div>' +
